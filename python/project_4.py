...
def matrix_input():
    ...
    print("please enter one digit and hit enter befire putting in the next one")
...
def main():
    ...
    while True:
        ...
        while True:
            print("Please make sure to add the - characters or it will complain")
        ...
        while True:
            print("Please make sure to add the - character or it will complain")
